...
*   [quantumaikr/quant.cpp](https://github.com/quantumaikr/quant.cpp) - Embeddable LLM inference in pure C. 33K LOC, zero dependencies. Delta KV compression — 4x longer context. Inspired by TurboQuant (ICLR 2026).
