...
*   [rmourey26/onyx](https://github.com/rmourey26/onyx) - Full stack NextJS 14 with Supabase SSR Auth & PostgreSQL DB, TanStack React Query, React Hook Form, Zod validation, RBAC, Resend,CRUD operations, Shadcn-UI, admin dashboard OpenAI playground, and more. Fork and get your MVP running in days.
...
*   [Irys-xyz/js-sdk](https://github.com/Irys-xyz/js-sdk) - JS SDK for Irys on Arweave
...
*   [nvedant/create-chakra](https://github.com/nvedant/create-chakra) - 🌈 cli tool to scaffold chakra ui projects, without wasting time
...
*   [Kielx/terminal-portfolio](https://github.com/Kielx/terminal-portfolio) - Terminal-portfolio - ideal for showcasing software developer projects.
...
*   [carolinedfrasca/llamaindex-chat-with-streamlit-docs](https://github.com/carolinedfrasca/llamaindex-chat-with-streamlit-docs) - Build a chatbot powered by LlamaIndex that augments GPT 3.5 with the contents of the Streamlit docs (or your own data).
...
*   [jakobdylanc/llmcord.py](https://github.com/jakobdylanc/llmcord.py) - A Discord LLM chat bot that supports any OpenAI compatible API (OpenAI, Mistral, Groq, OpenRouter, ollama, oobabooga, Jan and more)
...
*   [ditto-assistant/assistant](https://github.com/ditto-assistant/assistant) - AI assistant using Google TTS/STT, Keras, NLTK, Spacy, GPT-3, GPT-4, Hugging Face, Home Assistant, Spotify, and more.
...
*   [infinis/GPT3-Domain-Generator](https://github.com/infinis/GPT3-Domain-Generator) - Domain availability checker that uses GPT-3 to generate unique business name ideas based on the keywords and a short description provided by the user
...
*   [isislab-unisa/3Dify-first-release](https://github.com/isislab-unisa/3Dify-first-release) - Automatic avatar generator from 2D image
...
*   [rive-app/rive-runtime](https://github.com/rive-app/rive-runtime) - Downstream repo for Rive renderer
